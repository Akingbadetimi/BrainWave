  ...
  return (
    ...
    >
      <div className="flex item-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem] xl:mr-8 py-6" href="#hero">
        ...
        <a
          href="#signup"
          className="button hidden mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:block py-10"
        >
          New Account
        </a>
